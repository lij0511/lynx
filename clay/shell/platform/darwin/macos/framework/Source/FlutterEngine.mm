...
#include "clay/shell/platform/darwin/macos/framework/Source/overlay_platform_plugin_mac.h"
...
- (BOOL)runWithEntrypoint:(NSString*)entrypoint {
  ...
  _service_manager->RegisterService<clay::OverlayViewControllerService>(
      std::make_shared<clay::OverlayViewControllerService>(
          self, _clayViewProvider.overlayView));
  _service_manager->RegisterService<clay::OverlayService>(
      std::make_shared<clay::OverlayPlatformServiceMac>());
